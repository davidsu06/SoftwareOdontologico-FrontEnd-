                ...
                <div className="sidebar-sticky">
                    ...
                    <ul className="nav flex-column">
                        ...
                        <li className="nav-item">
                            ...
                            <a className="p-4 text-white text-decoration-none shadow d-block" data-toggle="collapse" href="#collapse5" role="button" aria-expanded="false" aria-controls="collapseExample" style={{backgroundColor:'#196B81'}}>
                                Historia clínica
                            </a>
